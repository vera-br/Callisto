...
#ax[0,0].plot(B_PDS[0], B_sheet_com[:,0], label='Full Ext.', color='r')
ax[0,0].set_title('Bx')
...
#ax[0,1].plot(B_PDS[0], B_sheet_com[:,1], label='Full Ext.', color='r')
ax[0,1].set_title('By')
...
#ax[1,0].plot(B_PDS[0], B_sheet_com[:,2], label='Full Ext.', color='r')
ax[1,0].set_title('Bz')
