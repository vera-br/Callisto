...
ax[0, 0].plot(B_PDS[0], Bx_smooth, label='PDS smooth', color='k')
...
ax[0, 1].plot(B_PDS[0], By_smooth, label='PDS smooth', color='k')
...
ax[1, 0].plot(B_PDS[0], Bz_smooth, label='PDS smooth', color='k')
...
ax[1, 1].plot(B_PDS[0], Bmag_smooth, label='PDS smooth', color='k')
