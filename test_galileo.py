...
# ax[0,0].plot(B_PDS[0], B_PDS[1])
# ax[0,0].plot(B_PDS[0], Bx_smooth, '--', label='Smoothed')

# ax[0,1].plot(B_PDS[0], B_PDS[2])
# ax[0,1].plot(B_PDS[0], By_smooth, '--', label='Smoothed')

# ax[1,0].plot(B_PDS[0], B_PDS[3])
# ax[1,0].plot(B_PDS[0], Bz_smooth, '--', label='Smoothed')

# ax[1,1].plot(B_PDS[0], B_mag)
# ax[1,1].plot(B_PDS[0], Bmag_smooth, '--', label='Smoothed')
# plt.show()
...
r_cores = np.array([0.005, 0.1, 0.15]) * R_C ; r_oceans = np.array([0.4, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75]) * R_C ; r_ionos = np.array([1.025, 1.05, 1.1]) * R_C
sig_cores = [1e-9, 5e-8, 1e-6]    ; sig_oceans = np.array([0.005, 0.01, 0.05, 0.1, 0.5])      ; sig_surfaces = [1e-9, 1e-7, 1e-5] ; sig_ionos = np.array([0.00005, 0.0001, 0.0005, 0.001])
