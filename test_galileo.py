...
Bx_model_1.plot(ax=ax[0,0], label="surface = " + str(0.2 * R_C / 1e3) + "km", color="midnightblue", alpha=.3)
Bx_model_2.plot(ax=ax[0,0], label="surface = " + str(0.1 * R_C / 1e3) + "km", color="gold", alpha=.3)
Bx_model_3.plot(ax=ax[0,0], label="surface = " + str(0.05 * R_C / 1e3) + "km", color="deeppink", alpha=.3)
ax[0,0].set_title('Bx')

By_Gal.plot(ax=ax[0,1], label="Data", color="skyblue")
By_model_1.plot(ax=ax[0,1], label="surface = " + str(0.2 * R_C / 1e3) + "km", color="midnightblue", alpha=.3)
By_model_2.plot(ax=ax[0,1], label="surface = " + str(0.1 * R_C / 1e3) + "km", color="gold", alpha=.3)
By_model_3.plot(ax=ax[0,1], label="surface = " + str(0.05 * R_C / 1e3) + "km", color="deeppink", alpha=.3)
ax[0,1].set_title('By')

Bz_Gal.plot(ax=ax[1,0], label="Data", color="skyblue")
Bz_model_1.plot(ax=ax[1,0], label="surface = " + str(0.2 * R_C / 1e3) + "km", color="midnightblue", alpha=.3)
Bz_model_2.plot(ax=ax[1,0], label="surface = " + str(0.1 * R_C / 1e3) + "km", color="gold", alpha=.3)
Bz_model_3.plot(ax=ax[1,0], label="surface = " + str(0.05 * R_C / 1e3) + "km", color="deeppink", alpha=.3)
ax[1,0].set_title('Bz')

Bmag_Gal.plot(ax=ax[1,1], label="Data", color="skyblue")
Bmag_model_1.plot(ax=ax[1,1], label="surface = " + str(0.2 * R_C / 1e3) + "km", color="midnightblue", alpha=.3)
Bmag_model_2.plot(ax=ax[1,1], label="surface = " + str(0.1 * R_C / 1e3) + "km", color="gold", alpha=.3)
Bmag_model_3.plot(ax=ax[1,1], label="surface = " + str(0.05 * R_C / 1e3) + "km", color="deeppink", alpha=.3)
ax[1,1].set_title('|B|')
