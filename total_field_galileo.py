...
# current sheet
# B_sheet_og = B_sheet_Community(orbit_cal_SIII)
...
print(np.shape(B_full_ext_og))
#B_full_ext_og = convert_B_to_PDS_CPhiO(B_full_ext_og, orbit_cal_SIII, orbit_cal_SIII_CA)
B_full_ext = convert_B_to_PDS_CPhiO(B_full_ext_og, orbit_cal_SIII, orbit_cal_SIII_CA)
print(np.shape(B_full_ext_og))
