...
cbar1 = ax[1].contourf(x_grid, y_grid, real_A, levels_real_A, cmap='Reds')
# fig.colorbar(cbar1, ax=[ax[0], ax[1]], ticks=np.linspace(0,1,6))
cs0 = ax[0].contour(x_grid, y_grid, abs_A, levels_real_A_contour, colors='k')
cs1 = ax[1].contour(x_grid, y_grid, real_A, levels_real_A_contour, colors='k')

cbar2 = ax[2].contourf(x_grid, y_grid, phi_grid, levels_phi, cmap='seismic')
# fig.colorbar(cbar2, ax=ax[2], ticks=np.linspace(-90, 90, 5))
cs2 = ax[2].contour(x_grid, y_grid, phi_grid, levels_phi, colors='k')

cbar3 = ax[3].contourf(x_grid, y_grid, norm_rsq_err, levels_rsq, cmap='Reds_r', extend='max')
# fig.colorbar(cbar3, ticks=np.linspace(0,1,6))
cs3 = ax[3].contour(x_grid, y_grid, norm_rsq_err, levels_rsq_contour, colors='k')

# cbar4 = ax[4].contourf(x_grid, y_grid, r2_grid, levels_real_A, cmap='Reds', extend='min')
# fig.colorbar(cbar4)
# cs4 = ax[4].contour(x_grid, y_grid, r2_grid, levels_real_A_contour, colors='k')
...
plt.clabel(cs0, manual=True)
plt.clabel(cs1, manual=True)
plt.clabel(cs2, manual=True)
plt.clabel(cs3, manual=True)
# plt.clabel(cs4, manual=True)
