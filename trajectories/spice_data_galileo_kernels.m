...
for i = 1:length(closest_approach_times)
    ...
    callisto_jupiter_SIII_mag = cspice_spkezr('GALILEO ORBITER', et_R, 'JUICE_JUPITER_MAG_S3RH2009', 'NONE', '599');
    writematrix([callisto_jupiter_SIII_mag;et_R], append('spice_data/galileo_wrt_jupiter_SIII_GK',string(i),'.csv'));
