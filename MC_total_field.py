...
Bext_ecc, Bext_ecc_var = Bext_eccentric_variation(positions=callisto_wrt_jupiter)
...
Bext_syn, Bext_syn_var = Bext_synodic_variation(pos_avg=np.mean(juice_wrt_jupiter, axis=0), times=t)
...
# i think this is to compara galileo measurements with model prediction
# params = {
#         "axes.labelsize": 14,
#         "font.size": 18,
#         "legend.fontsize": 22,
...
# axs.plot(t / 3600, Bext_ecc.transpose()[-1], color="black", linestyle="-.", linewidth=1.)
