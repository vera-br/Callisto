...
galileo_wrt_jupiter_SIII = Galileo_trajectories_SIII_from_CPhiO2()
...
orbit_SIII2 = galileo_wrt_jupiter_SIII2["orbit%s" % (flyby_n)]
...
orbit_SIII2[1:5] = orbit_SIII2[1:5] / R_J
...
ax[0,0].plot(orbit_SIII[0], orbit_SIII2[1], 'b')
ax[0,1].plot(orbit_SIII[0], orbit_SIII2[2], 'b')
ax[0,2].plot(orbit_SIII[0], orbit_SIII2[3], 'b')
ax[1,0].plot(orbit_SIII[0], orbit_SIII2[4], 'b')
ax[1,1].plot(orbit_SIII[0], orbit_SIII2[5], 'b')
ax[1,2].plot(orbit_SIII[0], orbit_SIII2[6], 'b')
